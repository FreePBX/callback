...
<?php		}?>
	...
	<tr>
		<td><a href="#" class="info"><?php echo _("Callback Number:")?><span><?php echo _("Optional: Enter the number to dial for the callback. Leave this blank to just dial the incoming CallerID Number. This field will accept \${Callerid(number)} as a placeholder for the incoming CallerID Number so it can be modified before dialing.")?></span></a></td>
